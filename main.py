...
screen_1.title("PYPONG")
screen_1.bgcolor("Black")
screen_1.setup(width = 900, height = 800)
...
sketch_1.hideturtle()
sketch_1.goto(0, 260)
sketch_1.write("Red: 0    Blue: 0",
             align = "center", font = ("monospace", 24, "normal"))
...
while True:
    ...
    if hit_ball.xcor() > 500:
        ...
        left_player += 1
        sketch_1.clear()
        sketch_1.write("Red: {}    Blue: {}".format(
